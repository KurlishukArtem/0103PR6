    ...
    class GetDataUser extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                Document doc_b = Jsoup.connect("http://169.254.137.22/index.php?login=" + login + "&password=" + password).get();
                body = doc_b.text();
    ...
    class SetDataUser extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... params)
        {
            ...
            try {
                ...
                doc_b = Jsoup.connect("http://169.254.137.22/regin.php?login=" + login + "&password=" + password).get();
                body = doc_b.text();
